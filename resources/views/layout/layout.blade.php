...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css"
        integrity="sha512-CmXf+4Pq3z+4Z0hJhfQ2IkL74S5y+fR+NGt+gO++1ihF5qw5+QOZlzsOw71JJK/7b1YHtStqnOxI/nG9DzIAvg=="
    ...
    <style>
        ...
        @media screen and (max-width: 768px) {
            ...
            /* Ajustar la sombra y el radio de borde para pantallas más pequeñas */
            .card {
        ...
        @media screen and (max-width: 768px) {
            ...
            /* Ajustar el ancho y el margen superior para pantallas más pequeñas */
            .cards-container {
                display: contents;
